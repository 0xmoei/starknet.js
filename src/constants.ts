...
export const HEX_STR_TRANSACTION_VERSION_3 = '0x2';
export const BN_TRANSACTION_VERSION_2 = 1n;
export const BN_TRANSACTION_VERSION_3 = 2n;
export const BN_FEE_TRANSACTION_VERSION_2 = 2n ** 128n + BN_TRANSACTION_VERSION_1;
export const BN_FEE_TRANSACTION_VERSION_3 = 2n ** 128n + BN_TRANSACTION_VERSION_2;
